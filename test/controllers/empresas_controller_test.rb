...
class EmpresasControllerTest < ActionController::TestCase
  ...
  test "should create empresa" do
    assert_difference('Empresa.count') do
      post :create, empresa: { direccion: @empresa.direccion, nombre: @empresa.nombre, rubro: @empresa.rubro, rut: @empresa.rut }
    end
  ...
  test "should update empresa" do
    patch :update, id: @empresa, empresa: { direccion: @empresa.direccion, nombre: @empresa.nombre, rubro: @empresa.rubro, rut: @empresa.rut }
    assert_redirected_to empresa_path(assigns(:empresa))
  end
