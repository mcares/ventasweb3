...
class ProductosControllerTest < ActionController::TestCase
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post :create, producto: { codigo: @producto.codigo, empresa_id: @producto.empresa_id, nombre: @producto.nombre, tipo: @producto.tipo, valor: @producto.valor }
    end
  ...
  test "should update producto" do
    patch :update, id: @producto, producto: { codigo: @producto.codigo, empresa_id: @producto.empresa_id, nombre: @producto.nombre, tipo: @producto.tipo, valor: @producto.valor }
    assert_redirected_to producto_path(assigns(:producto))
  end
